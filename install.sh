...
clear;clear;clear
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To ROSI CENTER STORE Project Script Installer ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Auther : ${green} Tunneling VVIP ${NC}${YELLOW}(${NC} ${green}Rosi Center${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
...
echo -e "\e[32mloading...\e[0m"
clear
izinsc="https://raw.githubusercontent.com/frosi4524/ijin/refs/heads/main/coklat"
rm -f /usr/bin/user
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/frosi4524/coklat/refs/heads/main/"
start=$(date +%s)
secs_to_human() {
...
wget https://raw.githubusercontent.com/frosi4524/coklat/refs/heads/main/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
"'&reply_markup={"inline_keyboard":[[{"text":"Website","url":"https://rasi.serv00.net"},{"text":"Grup","url":"https://wa.me/6281931472448"}]]}'
...
wget https://github.com/frosi4524/coklat/raw/refs/heads/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -O /usr/bin/ws "https://github.com/frosi4524/coklat/raw/refs/heads/main/ws/ws" >/dev/null 2>&1
wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/frosi4524/coklat/refs/heads/main/ws/tun.conf" >/dev/null 2>&1
wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/frosi4524/coklat/refs/heads/main/ws/ws.service" >/dev/null 2>&1
...
wget https://github.com/frosi4524/coklat/raw/refs/heads/main/Cdy/menu.zip
unzip menu.zip
chmod +x menu/*
