...
wget raw.githubusercontent.com/frosi4524/coklat/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -O /usr/bin/ws "https://raw.githubusercontent.com/frosi4524/coklat/refs/heads/main/ws/ws" >/dev/null 2>&1
...
print_success "NOOBZVPNS BY ROSI CENTER"
}
